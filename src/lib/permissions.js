...
export const DEFAULT_PROFILES = [
  {
    ...
    permissions: {
      ...
      cronograma_concluir_fase: true, cronograma_recalcular: true,
      ...
      termo_ver: true, termo_editar: true, termo_pdf: true,
  ...
  },
  {
    ...
    permissions: {
      ...
      cronograma_concluir_fase: true, cronograma_recalcular: false,
      tap_ver: true, tap_editar: false, tap_gerar_pdf: false,
      status_report_ver: true, status_report_editar: true,
      status_report_atualizar: true, status_report_email: true,
      termo_ver: true, termo_editar: false, termo_pdf: false,
