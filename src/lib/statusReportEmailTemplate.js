...
<table width="640" cellpadding="0" cellspacing="0" border="0" style="max-width:640px;width:100%;">
  ...
  <tr>
    <td style="background:linear-gradient(135deg,#6d28d9,#4c1d95);border-radius:16px;padding:28px 32px;margin-bottom:20px;">
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td>
            <p style="margin:0 0 4px;font-size:11px;font-weight:700;color:#c4b5fd;text-transform:uppercase;letter-spacing:2px;">Pontotel · Implantação</p>
  ...
  <tr>
    <td style="padding:16px 0;text-align:center;font-size:11px;color:#94a3b8;">
      Gerado automaticamente pelo Flowimplanta · Pontotel
    </td>
  </tr>
