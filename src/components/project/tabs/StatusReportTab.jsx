    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-purple-700 to-purple-900 rounded-2xl px-8 py-7 text-white">
        <div className="flex items-start justify-between">
          <div>
            <p className="text-xs font-semibold text-purple-300 uppercase tracking-widest mb-1"><img src="https://media.base44.com/images/public/69e295c073bbccc7f63f6156/1a9549a83_LogoPontotel_AmarelaePreta.png" style={{height:18,verticalAlign:'middle'}} alt="Pontotel" /> · Implantação</p>
