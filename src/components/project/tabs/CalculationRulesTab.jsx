...
import { ChevronLeft, ChevronRight, Save, CheckCircle, Loader2, FileDown, RotateCcw, AlertCircle, Lock, Info, Trash2, Maximize2, Minimize2, Link, Copy } from "lucide-react";
...
export default function CalculationRulesTab({ projectId, project }) {
  ...
  const generateClientLink = async () => {
    ...
    const res = await base44.functions.invoke('generateClientToken', { project_id: projectId });
            ...
            <>
              {clientLink ? (
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-1.5 text-xs font-medium rounded-lg border border-purple-200 bg-purple-50 text-purple-700 hover:bg-purple-100 disabled:opacity-60 transition-colors"
                >
