import { inputClass, labelClass, selectClass } from "@/lib/calcRulesStandaloneShared";
...
export default function RegrasForm({ companyData, data, onChange }) {
  ...
  const d = data || {};
  const selected = (name) => d[name] || { model: "", entradaToleranciaAtraso: "", saidaToleranciaAntecipada: "", entradaToleranciaExtra: "", saidaToleranciaExtra: "", janelaAntes: "", janelaDepois: "" };
